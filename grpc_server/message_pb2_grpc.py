...
class GITCommitMessageStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetCommitMessage = channel.unary_unary(
...
class GITCommitMessageServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_GITCommitMessageServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetCommitMessage': grpc.unary_unary_rpc_method_handler(
                    servicer.GetCommitMessage,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'GITCommitMessage.GITCommitMessage', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('GITCommitMessage.GITCommitMessage', rpc_method_handlers)
